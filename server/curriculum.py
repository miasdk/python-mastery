    ...
    def _get_variables_problems(self) -> List[Dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "description": "**Time Zone Converter**\n**Hard - Complex Calculations**\n\n**What You're Building:**\nCreate a timezone conversion tool for international meeting scheduling. Convert meeting times between different global time zones accurately.\n\n**Your Task:**\n- Convert local time to UTC minutes as integer\n- Apply target timezone offset as integer\n- Calculate new hour using modulo for 24-hour format\n- Calculate new minute as integer\n- Return new hour and minute as tuple\n\n**Skills Practiced:** Time Calculations • Modulo Operations • Integer Division\n\n**Example:**\n```python\nhour, minute = convert_time_zones(14, 30, -5, -8)\nprint(f\"Meeting time: {hour}:{minute:02d}\")\n# Output: \"Meeting time: 11:30\"\n```",
                "difficulty": "hard",
            ...
            },
            {
                ...
                "description": "**Investment Portfolio**\n**Hard - Financial Analysis**\n\n**What You're Building:**\nCreate a portfolio tracker for investment management software. Calculate total value and returns across different asset types.\n\n**Your Task:**\n- Calculate total portfolio value as float\n- Apply return rates to each asset type as float\n- Calculate new portfolio value as float\n- Calculate percentage return as float\n- Return original value, new value, and return percentage as tuple\n\n**Skills Practiced:** Financial Calculations • Percentage Math • Multi-step Operations\n\n**Example:**\n```python\nold, new, return_pct = portfolio_analysis(10000, 5000, 2000, 0.08, 0.03, -0.15)\nprint(f\"Portfolio: ${old} → ${new} ({return_pct:.1f}%)\")\n# Output: \"Portfolio: $17000 → $16950.0 (-0.3%)\"\n```",
                "difficulty": "hard",
            ...
            },
            {
                ...
                "description": "**Health Metrics Calculator**\n**Medium - Health Analysis**\n\n**What You're Building:**\nCreate a BMI calculator for a health tracking app. Calculate body mass index and determine health category based on medical standards.\n\n**Your Task:**\n- Convert height from centimeters to meters as float\n- Calculate BMI using weight and height squared as float\n- Determine health category as string based on BMI ranges\n- Round BMI to 1 decimal place\n- Return BMI and category as tuple\n\n**Skills Practiced:** Mathematical Formulas • Conditional Logic • Data Classification\n\n**Example:**\n```python\nbmi, category = health_metrics(70, 175)\nprint(f\"BMI: {bmi} ({category})\")\n# Output: \"BMI: 22.9 (normal)\"\n```",
                "difficulty": "medium",
